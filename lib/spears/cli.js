...
module.exports = function Cli(args) {
  ...
  this.run = function (callback) {
    var i, suites, tags, args, configuration, runtime
    ...
    queue.on('finish', function () {
      ...
      var code = (ColorFormatter.hasError()) ? 1 : 0;
      callback(code);
    });
    ...
    for (i in suites) {
      ...
      if (tags) {
        configuration = Cucumber.Cli.Configuration([0, 0, suites[i], tags]);
      } else {
